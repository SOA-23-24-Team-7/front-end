...
export class MarketplaceService {
  ...
  getPublishedTours(): Observable<PagedResults<Tour>> {
    return this.http.get<PagedResults<Tour>>(environment.apiHost + 'market-place/tours/published');
  }

  getToursFirstKeyPoint(tourId: number): Observable<KeyPoint> {
    return this.http.get<KeyPoint>(environment.apiHost + 'market-place/tours/' + tourId + '/first-key-point');
  }
}
