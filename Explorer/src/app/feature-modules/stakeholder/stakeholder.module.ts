...
@NgModule({
  declarations: [UserProfileComponent, EditProfileComponent, ProblemCommentComponent, ProblemCommentListComponent, ProblemCommentCreateComponent, ProblemResolveComponent],
